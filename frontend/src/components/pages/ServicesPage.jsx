...
const ServicesPage = () => {
  const services = [
    ...
    },
    {
      ...
      description: "Professional garden waste removal including green waste, garden furniture, tools, and outdoor equipment disposal.",
    ...
    },
    {
      ...
      description: "Efficient commercial waste removal for offices, including furniture, equipment, and confidential document disposal.",
    ...
    {
      title: "Single Items",
      description: "Individual item removal service for sofas, mattresses, appliances, and other bulky items with transparent pricing.",
              ...
              <div key={index} className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                ...
                <div className="p-6">
                  <div className="flex items-center mb-4">
                    <div className="p-2 bg-teal-100 rounded-lg text-teal-600 mr-4">
                      {service.icon}
                    </div>
                  ...
                  <Link to={service.path}>
                    <Button className="w-full bg-teal-600 hover:bg-teal-700 text-white font-medium flex items-center justify-center">
                      Learn More
